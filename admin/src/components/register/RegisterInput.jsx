...
const RegisterInput = () => {
  ...
  return (
    <div className="bg-[#CEE5FF] relative h-screen flex justify-center items-center p-6">
      <button className="top-7 absolute left-7">
        <IoMdArrowRoundBack className=" text-4xl hover:text-white duration-300" />
      </button>
